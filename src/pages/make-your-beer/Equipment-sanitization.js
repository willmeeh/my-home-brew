...
class EquipmentSanitization extends Component {
    ...
    render() {
        const texts = [
            { 'title': 'Sanitização: Você não pode errar na sua cerveja' },
            { 'title': 'LIMPEZA' },
            { 'title': 'SANITIZAÇÃO' },
            { 'title': 'ESTERILIZAÇÃO' },
        ]
            ...
            <Fragment>
                <Layout className="page-layout" >
                    <Content className="page-content" style={{ padding: '5vh 20vh'}}>
                        ...
                        <Title id={this.createIdFromTitle('LIMPEZA')} level={4}>LIMPEZA</Title>
                        ...
                        <Title id={this.createIdFromTitle('SANITIZAÇÃO')} level={4}>SANITIZAÇÃO</Title>
                        ...
                        <Title id={this.createIdFromTitle('ESTERILIZAÇÃO')} level={4}>ESTERILIZAÇÃO</Title>
